  ...
  return (
    <Section id="research" title="05. Research Publication">
      <motion.div className="bg-navy-light rounded-lg p-8 border border-transparent hover:border-cyan hover:-translate-y-2 transition-all duration-300 shadow-lg" whileHover={{ y: -8 }}>
        ...
        <p className="text-slate">Proposed FORC, a federated multi-agent framework achieving 85.3% task resolution vs 54.1% single-LLM baseline (57.6% gain) and reducing mean time-to-merge from 4.2 h to 1.8 h on SWE-bench-Enterprise (840 tasks). <span className="text-slate-light font-semibold">IEEE Conference Paper (Under Review)</span>.</p>
      </motion.div>
    </Section>
  );
}
